...
default["worker"]["windows"]["env"]["JAVA_OPTS"]   = "-Xms1536M -Xmx1536M -Xss1M -XX:MaxPermSize=256M -XX:ReservedCodeCacheSize=128M -XX:+UseParallelGC -XX:+UseCompressedOops"
default["worker"]["windows"]["env"]["ANT_OPTS"]    = node["worker"]["windows"]["env"]["JAVA_OPTS"]
default["worker"]["windows"]["env"]["sbtLauncher"] = "#{node['sbt']['launcher_path']}/sbt-launcher.jar"
default["worker"]["windows"]["env"]["WIX"]         = node["wix"]["home"]
