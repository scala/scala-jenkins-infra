...
default['master']['env'] = <<-'EOH'.gsub(/^ {2}/, '')
  lambda{| node | Chef::Node::ImmutableMash.new({
    "JAVA_OPTS"  => "-server -XX:+DoEscapeAnalysis -XX:+UseCompressedOops -Xmx2G -Xss1M -XX:MaxPermSize=384M -XX:ReservedCodeCacheSize=128M -XX:+UseParallelGC -Dpartest.threads=4",
    "ANT_OPTS"   => "-server -XX:+DoEscapeAnalysis -XX:+UseCompressedOops -Xmx2G -Xss1M -XX:MaxPermSize=384M -XX:ReservedCodeCacheSize=128M -XX:+UseParallelGC -Dpartest.threads=4",
    "MAVEN_OPTS" => "-server -XX:+DoEscapeAnalysis -XX:+UseCompressedOops -Xmx2G -Xss1M -XX:MaxPermSize=384M -XX:ReservedCodeCacheSize=128M -XX:+UseParallelGC",
